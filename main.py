...
trubs = []
create_trub = pygame.K_SPACE + 1
pygame.time.set_timer(create_trub, 1300)
...
def sozd_trub():
    ruba_y = random.choice(truba_height)
    top_trub = truba.get_rect(midbottom=(377, ruba_y - 210))
    bottom_trub = truba.get_rect(midtop=(377, ruba_y))
    return top_trub, bottom_trub
